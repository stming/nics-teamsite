...
public class navCategories {
    ...
    public Document getnavCategories(RequestContext context) throws DocumentException {
      ...
      String langValue = "";
        ...
        String dcrData = "";
        dcrData = context.getParameterString("nav_categories");
        String dcrDataLang = "/templatedata/" + langValue + dcrData.substring(18);


        java.io.InputStream is = fileDal.getStream(fileDal.getRoot() + dcrDataLang);
