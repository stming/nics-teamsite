...
public class NikonHBN8DAOManagerTxn2
extends AbstractTSEnvAwareHibernateDAOManager
implements NikonBusinessManager
{
	private Log log = LogFactory.getLog(NikonHBN8DAOManagerTxn2.class);
	private static Log staticLog = LogFactory.getLog(NikonHBN8DAOManagerTxn2.class);
//	private static SimpleMetricLogger metrics = SimpleMetricLogger.getInstance();
	//Name of the instantiated class in Spring. This should match the id given in the Spring
	//configuration file
	 ...
	 */
	public static final NikonHBN8DAOManagerTxn2 getSpringAppCtxInstance()
	throws BeanDefinitionStoreException
	{
		...
		return (NikonHBN8DAOManagerTxn2)o;
	}

	public NikonHBN8DAOManagerTxn2()
	{
...
//				metric.stopTiming();
			...
			catch(Exception ex)
			{
			  ...
			  {
				  log.error("listNavNewsArticles rollback"+ex2.toString(), ex);
			  }
			  
			  log.error("listNavNewsArticles", ex);
	...
	public List<ProductDTO> listCatalogueProducts(HBN8QueryParamDTO param)
	{
		...
		catProductDetails = (List<ProductDTO>)filterUnwantedLocales(catQuery.list(), new LocaleComparator(possibleLocales), ProductDTO.class);
