...
/**
 * Product2Accessory generated by hbm2java
 */
public class Product2Accessory implements java.io.Serializable {

	private Product2AccessoryPK id;
	...
	public Product2Accessory() {
	}

	public Product2Accessory(Product2AccessoryPK id) {
		this.id = id;
	}

	public Product2Accessory(Product2AccessoryPK id, String nikonLocale,
	...
	public Product2AccessoryPK getId() {
		return this.id;
	}

	public void setId(Product2AccessoryPK id) {
		this.id = id;
	}
