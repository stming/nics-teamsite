...
/**
 * Product2AccessoryPK generated by hbm2java
 */
public class Product2AccessoryPK implements java.io.Serializable {

	private String id;
	private String prodId;
	private String prodProdId;

	public Product2AccessoryPK() {
	}

	public Product2AccessoryPK(String id, String prodId, String prodProdId) {
		this.id = id;
		this.prodId = prodId;
