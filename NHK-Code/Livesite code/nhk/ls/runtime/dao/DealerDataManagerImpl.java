...
public class DealerDataManagerImpl implements DealerDataManager {
    ...
    @Override
    public List<Dealer> checkAndRetrieveByCountry(String countryName, String vendorType, String searchText, String regionSel, String citySel, List vendorNameList, String locale) throws DAOException {
    ...
    public List<Dealer> checkAndRetrieveByLocale(String locale, String vendorType, String searchText, String regionSel, String citySel, List vendorNameList) {
