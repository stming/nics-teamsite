...
public class DealerSearch {
        ...
        try {
            ...
            if (userClickedSearch.equalsIgnoreCase("Yes") || !countryReq.equalsIgnoreCase("1")) {
                ...
                if (countrySel.equalsIgnoreCase("")) {
                    ...
                    dealerList = retrieveAllDealersforLocale(locale, vendorType, searchText, regionSel, citySel, vendorNameList);
                } else {
                    ...
                    dealerList = retrieveAllDealersforCountry(countrySel, vendorType, searchText, regionSel, citySel, vendorNameList, masterListLocale);
                }
    ...
    public List<Dealer> retrieveAllDealersforLocale(String locale, String vendorType,
            String searchText, String regionSel, String citySel, List vendorNameList) throws DAOException {
        List<Dealer> resultLocCountry = dataManager.checkAndRetrieveByLocale(locale, vendorType, searchText, regionSel, citySel, vendorNameList);
    ...
    public List<Dealer> retrieveAllDealersforCountry(String country, String vendorType,
            String searchText, String regionSel, String citySel, List vendorNameList, String locale) throws DAOException {
        List<Dealer> resultCountry = dataManager.checkAndRetrieveByCountry(country, vendorType, searchText, regionSel, citySel, vendorNameList, locale);
